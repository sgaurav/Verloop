...
public class PostActivity extends Activity {
  private EditText postEditTitle;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    postEditTitle = (EditText) findViewById(R.id.post_editTitle);
  ...
  private void post () {
    String title = postEditTitle.getText().toString().trim();
    ...
    VerloopPost post = new VerloopPost();
